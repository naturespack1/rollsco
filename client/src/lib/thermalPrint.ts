...
<body><div class="center mb"><div class="store-name">ROLLS & CO.</div><div class="small bold">${escapeHtml(storeName)}</div><div class="tiny">${escapeHtml(storeAddress)}</div><div class="tiny">GST INVOICE</div></div>
